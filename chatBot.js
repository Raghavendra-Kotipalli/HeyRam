$(document).ready(function(){
  ...
  document.head.appendChild(chatBotCssLink);
	...
	messageBox.innerHTML = '<div id ="botIcon"> <b>Hey Ram</b> </div> <div id="botBox"> <div class="botHead"> <span>Mr Ram Bot</span> <img src="images/close.png" class="closeBtn"> </div> <div id="messageBody"><span class="userReqData"> Hello</span></div> <div class="requestBody"> <div class="userInputDiv"> <input type="text" placeholder="Search.." name="userRequest" id="userRequest" autocomplete="off"> <button type="submit" id="sendUserReq"> <img src="images/sendBtn.png" class="sendBtn" /> </button> </div> </div> </div>';
